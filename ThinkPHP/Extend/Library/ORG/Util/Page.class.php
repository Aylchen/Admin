...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'&laquo;','next'=>'&raquo;','first'=>'第一页','last'=>'最后一页','theme'=>'<span> %totalRow% %header% %nowPage%/%totalPage% 页</span><ul> %upPage% %first%  %prePage%  %linkPage%  %nextPage% %end% %downPage% </ul>');
    // 默认分页变量名
    protected $varPage;
    ...
    public function __construct($totalRows,$listRows='',$parameter='',$url='') {
        ...
        $this->varPage      =   C('VAR_PAGE') ? C('VAR_PAGE') : 'var_page' ;
        if(!empty($listRows)) {
